...
<body>
        ...
        <div class="offcanvas-body">
            ...
            <ul class="nav nav-pills flex-column mb-auto" id="sidebar-items">
                <li class="py-2 rounded-3">
                    <div class="dropdown">
                        <a class="nav-link text-white dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <li class="py-2 rounded-3">
                    <a href="mis_estadisticas.php" class="nav-link active text-white">
    ...
    <div class="container py-4">
        ...
        <h1 class="text-center">Tus estadísticas</h1>
                    ...
                    <table class="table table-sm table-hover text-white">
                        ...
                        <tbody id="tabla-stats">
                            <tr>
                                ...
                                <td id="puntosTotales"></td>
                            </tr>
                            <tr>
                                <td><b>Partidas ganadas en Blackjack</b></td>
                                <td id="ganadaBJ"></td>
                            </tr>
                            <tr>
                                <td><b>Partidas perdidas en Blackjack</b></td>
                                <td id="perdidaBJ"></td>
                            </tr>
                            <tr>
                                <td><b>Partidas ganadas en Truco</b></td>
                                <td id="ganadaTruco"></td>
                            </tr>
                            <tr>
                                <td><b>Partidas perdidas en Truco</b></td>
                                <td id="perdidaTruco"></td>
                            </tr>
                            <tr>
                                <td><b>Total de coins cargadas</b></td>
                                <td id="totalCoins"></td>
                            </tr>
                        </tbody>
                    </table>
    ...
    <script src="js/Ajax/ajax_estadisticas.js"></script>
