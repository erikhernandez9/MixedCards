...
$consulta = "INSERT INTO movimiento (id_usuario, usuario_cartera, movimiento_fecha, movimiento_valor)
            VALUES ('$id', '$username', '$actual_date', '$cant')"; //Se cargan los datos
$cargar_mov = mysqli_query($conexion->conexion, ($consulta));



if($cargar_mov){ //Si la consulta es exitosa actualiza los datos en la cartera
