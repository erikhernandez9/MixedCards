/*
 * Archivo Ajax registra un usuario. 
 * 1- Se envian los datos del formulario de Register "index.html" mediante Ajax hacia el documento "modificar.php"
 * 2- Segun la respuesta obtenida se aplican cambios visuales en el formulario Register
*/
...
$(document).ready(function () {
    $("#register-form").submit(function (event) {
        ...
        $.ajax({
            type: "POST",
            url: "../FrontEndProyecto/php/registro.php",
...
function eventsRegisterForm(eI, vEF, vEE, vUF, vUE, vB, vP) {
    ...
    if (
        ...
        //No hay errores:
        $("#name-reg, #surname-reg, #username-reg, #email-reg, #tel-reg, #nac-reg, #passwd-reg, #passwd-rep-reg").val('');
