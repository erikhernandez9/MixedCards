    ...
    <div class="container-fluid">
        <div class="row">
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-page-green sidebar collapse">
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="nuevo_juego.php">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <hr>
                <div class="pt-1">
                    <button data-bs-toggle="modal" data-bs-target="#crear-juego-modal" class="btn btn-dark"><i class="bi bi-plus-circle me-2"></i>Crear juego</button>
                </div>
                <!-- Borrar juegos -->
                <div class="modal fade" id="borrar-juego-modal" tabindex="-1">
                            ...
                            <form id="alerta-eliminar">
                                <div class="modal-body">
                                    <div class="d-flex align-content-center justify-content-center mb-4">
                                        <h3 class="display-6 fs-1">¿Está seguro de eliminiar este juego?</h1>
                                    </div>
                                    <div class="d-flex align-content-center justify-content-center mb-4">
                                        <table class="table text-light table-sm w-50">
                                            ...
                                            <tbody id="tabla-usuarios">
                                                <tr>
                                                    ...
                                                    <td id="nom-eliminar-modal"></td>
                                                    <td id="pts-eliminar-modal"></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                ...
                <!-- Editar juegos Modal -->
                <div class="modal fade" id="editar-juego-modal" tabindex="-1">
                    <div class="modal-dialog modal-lg modal-dialog-centered">
                        <div class="modal-content bg-page-green text-white border rounded-3 border-light">
                            <form id="editar-juego-form" action="php/registro.php" method="POST" enctype="multipart/form-data">
                                <div class="modal-body">
                                    <div class="d-flex align-content-center justify-content-center mb-4">
                                        <h3 class="display-6 fs-1">Editar juego</h3>
                                    </div>
                                    <div class="row g-3 mb-3 mx-4">
                                        <div class="col-md-5 blur-bg-white text-white rounded-3 py-3 shadow">
                                            <div class="p-3 h-100 align-self-center">
                                                <div class="d-flex justify-content-center mb-1">
                                                    <h1 class="display-6" id="username-card-show">ID del juego</h1>
                                                </div>
                                                <div class="d-flex justify-content-center mb-1">
                                                    <h1 class="display-1" id="username-card-show">#<span id="id-juego-show"></span></h1>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-7">
                                            <div class="p-5 blur-bg-white text-white rounded-3 shadow">
                                                ...
                                                <input type="number" class="d-none" name="id-juego-edit" id="id-juego-edit">
                                                <div class="form-floating mb-3 text-light">
                                                    <input type="text" class="form-control border border-2 border-light rounded rounded-3 shadow" placeholder="Nombre" name="nom-edit" id="nom-edit" autocomplete="off" required>
                                                    <label for="floatingInput">Nombre</label>
                                                </div>
                                                <div class="form-floating mb-3 text-light">
                                                    <input type="number" class="form-control border border-2 border-light rounded rounded-3 shadow" placeholder="Puntos" name="pts-edit" id="pts-edit" autocomplete="off" required>
                ...
                <!-- Crear juegos Modal -->
                <div class="modal fade" id="crear-juego-modal" tabindex="-1">
                    <div class="modal-dialog modal-lg modal-dialog-centered">
                        <div class="modal-content bg-page-green text-white border rounded-3 border-light">
                            <form id="crear-juego-form" action="php/registro.php" method="POST" enctype="multipart/form-data">
                                <div class="modal-body">
                                    <div class="d-flex align-content-center justify-content-center mb-4">
                                        <h3 class="display-6 fs-1">Crear juego</h3>
                                    </div>
                                    <div class="d-flex justify-content-center">
                                        <div class="p-5 blur-bg-white text-white rounded-3 shadow w-75">
                                            <div id="mod-alert"></div>
                                            <input type="number" class="d-none" name="id-juego-edit" id="id-juego-edit">
                                            <div class="form-floating mb-3 text-light">
                                                <input type="text" class="form-control border border-2 border-light rounded rounded-3 shadow" placeholder="Nombre" name="nom-crear" id="nom-crear" autocomplete="off" required>
                                                <label for="floatingInput">Nombre</label>
                                            </div>
                                            <div class="form-floating mb-3 text-light">
                                                <input type="number" class="form-control border border-2 border-light rounded rounded-3 shadow" placeholder="Puntos" name="pts-crear" id="pts-crear" autocomplete="off" required>
                                                <label for="floatingInput">Puntos</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="d-flex align-self-center justify-content-center">
                                        <button class="w-25 btn btn-lg btn-outline-light border border-2 rounded-pill shadow mt-3" id="confirmar-guardar" type="submit">Crear</button>
                                        <button class="btn btn-lg btn-outline-danger rounded-pill shadow mt-3 ms-3" data-bs-dismiss="modal" type="button" id="confirmar-cancelar">Cancelar</button>
                                    </div>
                                </div>
                            </form>
                ...
                <script src="js/Ajax/ajax_mostrar_juegos.js"></script>
                <script src="js/Ajax/ajax_actualizar_juegos.js"></script>
                <script src="js/Ajax/ajax_crear_juego.js"></script>
